...
```
java -Dspring.profiles.active=production -jar ./target/Book-Reader-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=br.com.booksaas/book-reader
```
