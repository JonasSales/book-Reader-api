            ...
            <ul className="flex">
              ...
              <li className="relative">
                ...
                <ul className="hidden block absolute right-0 bg-white border border-gray-300 rounded min-w-[10rem] py-2" aria-labelledby="navbarEntitiesLink">
                  ...
                  <li><Link to="/books" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('book.list.headline')}</Link></li>
                  <li><Link to="/readingProgresses" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('readingProgress.list.headline')}</Link></li>
                  <li><Link to="/orders" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('order.list.headline')}</Link></li>
                  <li><Link to="/userSettings" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('userSetting.list.headline')}</Link></li>
                </ul>
              </li>
            </ul>
          </div>
