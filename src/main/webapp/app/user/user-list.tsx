      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th scope="col" className="text-left p-2">{t('user.fullName.label')}</th>
            <th scope="col" className="text-left p-2">{t('user.email.label')}</th>
            <th scope="col" className="text-left p-2">{t('user.password.label')}</th>
            <th scope="col" className="text-left p-2">{t('user.isPremium.label')}</th>
        ...
        <tbody className="border-t-2 border-black">
          ...
          <tr key={user.id} className="odd:bg-gray-100">
            ...
            <td className="p-2">{user.isPremium?.toString()}</td>
